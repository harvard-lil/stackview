...
(function ($) {
  ...
  var uid = +new Date(); // stack-view.js workaround (WORK AROUND TO WHAT?)
  var offset = 0;
  ...
  $.fn.stackView = function (options) {
    ...
    return this.each(function () {
      var scroller = $(this),
        ...
        vertical; // DOES NOT APPEAR ANYWHERE ELSE, DEAD
      
      axis = 'y'; // GLOBAL? ALSO NOT USED

      scroller.addClass('scroller');
      scroller.html('<div class="scroller-content"><div class="scroller-loading scroller-loading-prev" /><div class="scroller-page" /><div class="scroller-loading scroller-loading-next" /></div>'); // SWITCH TO TEMPLATE RENDERING

      var scrollerId = scroller.attr('id'); // SHOULD NOT ASSUME IT HAS AN ID
      ...
      $('#' + wrapperId + ' .ribbonBody').text(options.ribbon);
			...
			// PASSING FALSE TO OPTIONS... REPLACES THE SCROLLER ELEMENT
			// BUT WITHOUT EVENTS?  IS THIS EVEN USEFUL?
      if(options === false) {
        // Destroy!
